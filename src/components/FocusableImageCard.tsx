import { withHoverProps } from "../common/isHovering/IsHoveringContext";
...
function FocusableImageCard({ image, alt, label="", children }: PropsWithChildren<FocusableCardProps>){
        ...
        <div className='relative w-64 h-40 flex items-center justify-center'>
            <div
                className={`absolute  
                    ...
                    ${isFocused ? 'w-72 h-64 z-10' : 'w-64 h-40 z-0'} max-md:hover:h-72`
                }
...
export default FocusableImageCard;