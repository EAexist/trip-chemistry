...
// import { GoogleMapProps } from '../ui/ReactGoogleMap';
import { Coords } from './types';
import googleMapReact from 'google-map-react';

export const API_KEY = "AIzaSyBTIi-NbUzw9gdHynDTSpwng5GWbXA8D6M";
export const CENTER_FUKUOKA_TENJIN: Coords = { lat: 33.5900, lng: 130.40 };
const STYLE_DRAWING = [
  {
...
export const PROPS_TEST_SCHEDULE_PAGE : googleMapReact.Props = {  
